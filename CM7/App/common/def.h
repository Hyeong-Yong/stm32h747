...
#ifndef E2D091EB_2CA9_4DBA_A6B0_F6F11F1B1586
#define E2D091EB_2CA9_4DBA_A6B0_F6F11F1B1586
...
#define _DEF_OVTOCT1          0
#define _DEF_GALVANO1         1
...
#define _DEF_UART1            0   // USB-DBG (uart)
#define _DEF_UART2            1   // USB-OTG (usb-cdc)
#define _DEF_UART3            2
#define _DEF_UART4            3
...
static inline int32_t constrain_s32(int32_t x, int32_t lo, int32_t hi)
{
    if (x < lo) return lo;
    if (x > hi) return hi;
    return x;
...
static inline float bytes_to_float(uint8_t *rx)
{
    float f;
    memcpy(&f, rx, 4);
    return f;
...
#endif /* E2D091EB_2CA9_4DBA_A6B0_F6F11F1B1586 */
