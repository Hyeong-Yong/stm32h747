...
/* USER CODE BEGIN PV */
// IEC61850 Sampled Values task attributes
/* Definitions for IEC61850_SV */
osThreadId_t IEC61850_SVHandle;
const osThreadAttr_t IEC61850_SV_attributes = {
  .name = "IEC61850_SV",
  .stack_size = 512 * 4,
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(DAC8562_SPI_SYNC_GPIO_Port, DAC8562_SPI_SYNC_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOI, LED1_Pin|GPIO_PIN_13|LED3_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin : DAC8562_SPI_SYNC_Pin */
  GPIO_InitStruct.Pin = DAC8562_SPI_SYNC_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  HAL_GPIO_Init(DAC8562_SPI_SYNC_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : LED1_Pin PI13 LED3_Pin */
  GPIO_InitStruct.Pin = LED1_Pin|GPIO_PIN_13|LED3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void StartDefaultTask(void *argument)
{
  ...
  /* USER CODE BEGIN 5 */
  osDelay(2000);
  IEC61850_SVHandle = osThreadNew(IEC61850_SV_Task, NULL, &IEC61850_SV_attributes);
